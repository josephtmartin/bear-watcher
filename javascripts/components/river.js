      ...
      `<div class="card m-3 bear--card" style="width: 25%;">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-around">
                <button type="button" id="attempt-${index}" class="btn btn-primary btn-lg">Tried To Catch</button>
                <button type="button" id="catch-${index}" class="btn btn-primary btn-lg">Caught</button>
              </div>
